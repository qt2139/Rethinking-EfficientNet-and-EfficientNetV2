...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="flower_data/flower_data/flower_photos")

    # download model weights
    # 链接: https://pan.baidu.com/s/1ouX0UmjCsmSx3ZrqXbowjw  密码: 090i
    parser.add_argument('--weights', type=str, default='torch_efficientnet/torch_efficientnet/efficientnetb0.pth',          #CHANGE
